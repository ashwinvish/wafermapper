...
%     
    ...
    disp(sprintf('%s not found. Performing scale check.', IBSC_ScaleFactorFile_NameStr));
end
    
% Clearing memory before we do scale calculations
clearvars CurrentImage OriginalImage OriginalImage_Filtered OriginalImage_x3LargerROI;
