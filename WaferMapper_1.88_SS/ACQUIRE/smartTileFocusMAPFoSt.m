...
disp('Auto Focusing...');
MAPFoSt_Merlin(MAPFoSt_image_height,MAPFoSt_image_width,MAPFoSt_image_dwelltime_us,MAPFoSt_image_filename,MAPFoSt_image_FOV,MAPFoSt_maxiter,MAPFoSt_fallback,MAPFoSt_verbosity);
sm.Set_PassedTypeSingle('DP_BEAM_BLANKED',0);
    ...
    for o = 1:2
        ...
        if q.quality <= focOptions.QualityThreshold %if bad
           ...
           % LogFile_WriteLine(sprintf('!!!!! Autofocus failed to reach threshold %0.5g.',focOptions.QualityThreshold));
            ...
            Perform_AF_or_AFASAF_MAPFoSt(StartingMagForAF, IsPerformAutoStig, StartingMagForAS, focOptions);
