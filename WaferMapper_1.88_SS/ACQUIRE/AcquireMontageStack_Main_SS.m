function [  ] = AcquireMontageStack_Main_SS(handles)
...
GuiGlobalsStruct.autoBrightCon_SS2Counter = 1; %Change at some point. fixme
GuiGlobalsStruct.autoBrightCon_SS2Counter2 = 1; %Change at some point. fixme
GuiGlobalsStruct.autoBrightCon_Values = []; %fixme
...
%             disp(MyStr);
             ...
             %%%%
             %StageX_Meters = StageX_Meters - 0.00001202
             %StageY_Meters = StageY_Meters - 0.00000600
             %%%%
       ...
       %added by Av to resume AF from where the previous section finished.
        ...
        logBook = AcquireMontageAtCurrentPosition_SS(WaferName,LabelStr,logBook);
        logBook.waferProgress = waferProgress;
